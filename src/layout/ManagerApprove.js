...
export default function ManagerApprove() {
    ...
    if (listRender == undefined) {
        ...
        renderListHome = renderList.map((e) => {
            return (
                <form className=''>
                    <>
                        <hr className="my-4 " />
                        <div className="row mb-4 d-flex justify-content-between align-items-center mt-5">
                            ...
                            <div className="col-md-2 col-lg-21 col-xl-2 text-start ">
                                {e.status == "Borrowed" ? <>
                                    ...
                                    <h6 style={{ fontSize: '20px', color: '#ff9902' }}>
                    ...
                    <hr className="my-4" />
                    <div className='mb-3 text-end' style={{ paddingRight: '20px' }}>
                        {e.status == "Loading" ? <>
                            <button className='btn btn-success mx-2' type='button' onClick={(b) => handleCfBook(
                                e.id,
                            )}>
                            ...
                            <button className='btn btn-danger' type='button' onClick={(b) => handleCfBook(
                                e.id,
                            )}>
    ...
    return (
        ...
        <div style={{ backgroundColor: 'rgb(240, 240, 238)' }} className=''>
